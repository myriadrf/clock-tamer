...
#define DFU_DATA  __attribute__ ((section (".bootdata")))
	...
	/* Function Prototypes: */
		void SetupHardwareDFU(void) DFU_SECTION;
		void ResetHardwareDFU(void) DFU_SECTION;

		void DFU_EVENT_USB_Device_UnhandledControlRequest(void) DFU_SECTION;
        ...
        void InitDfuData(void) DFU_SECTION;
