...
#define _DESCRIPTORS_H_
	...
	/* Macros: */
      ...
      #define DFU_CONTROL_ENDPOINT_SIZE  32
#else
      #define DFU_CONTROL_ENDPOINT_SIZE   FIXED_CONTROL_ENDPOINT_SIZE
#endif
	...
	/* Function Prototypes: */
		...
		uint16_t CALLBACK_USB_GetDescriptor(const uint16_t wValue, const uint8_t wIndex, const void** const DescriptorAddress) DFU_SECTION
											ATTR_WARN_UNUSED_RESULT ATTR_NON_NULL_PTR_ARG(3);
