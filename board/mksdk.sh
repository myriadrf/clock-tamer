...
SYMBOLS="RunBootloader USB_CurrentlySelfPowered USB_RemoteWakeupEnabled USB_ConfigurationNumber USB_ControlEndpointSize USB_IsInitialized USB_DeviceState USB_ControlRequest"
