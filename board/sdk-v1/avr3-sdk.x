...
OUTPUT_ARCH(avr:3)
 ...
 RunBootloader = 0x00800101  ;
 USB_CurrentlySelfPowered = 0x00800104  ;
 USB_RemoteWakeupEnabled = 0x00800103  ;
 USB_ConfigurationNumber = 0x00800102  ;
 USB_ControlEndpointSize = 0x00800100  ;
 USB_IsInitialized = 0x00800105  ;
 USB_DeviceState = 0x0080010e  ;
 USB_ControlRequest = 0x00800106  ;
 eeHWInfo = 0x0081019b  ;

 __vector_11 = 0x00003d0a  ;
 USB_Device_ProcessControlRequest = 0x000039e4  ;
 USB_Init = 0x00003cf2  ;
 USB_ResetInterface = 0x00003c28  ;
 USB_ShutDown = 0x00003cd4  ;
 USB_INT_ClearAllInterrupts = 0x00003d04  ;
 USB_INT_DisableAllInterrupts = 0x00003cfe  ;
 USB_USBTask = 0x00003e5c  ;
 Endpoint_ConfigureEndpoint_Prv = 0x000030ba  ;
 Endpoint_ClearStatusStage = 0x0000310e  ;
 Endpoint_ClearEndpoints = 0x000030e0  ;
 Endpoint_BytesToEPSizeMaskDynamic = 0x0000309e  ;
 Endpoint_Write_Control_PStream_LE = 0x00003160  ;
 LanguageString = 0x00003eb1  ;
